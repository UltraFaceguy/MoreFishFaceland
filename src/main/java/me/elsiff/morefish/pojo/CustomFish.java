...
public class CustomFish {
  ...
  private final double fishingExperience;

  public CustomFish(String internalName, String name, double lengthMin, double lengthMax, ItemStack icon,
      boolean skipItemFormat, List<String> commands, FoodEffects foodEffects, List<Condition> conditions,
      Rarity rarity, double fishingExperience) {
